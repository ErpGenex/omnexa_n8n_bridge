...
from omnexa_n8n_bridge.nb_gap_register import get_gap_status
from omnexa_n8n_bridge.nb_global_benchmark import get_global_nb_score

@frappe.whitelist()
def export_nb_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_N8N_BRIDGE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_nb_score(), get_gap_status()
